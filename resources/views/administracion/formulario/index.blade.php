                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-3">
								<div class="mb-3">
									...
									<label for="dni" class="col-form-label">Icono Texto DNI:</label>
									<select class="form-control fontawesomeSelect" id="slcDni" name="slcDni">
                                            ...
                                            <option value='fa-mobile-screen'>&#xf10b; fa-mobile-screen</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                            <div class="mb-3">
                                    <input type="hidden" id="hdnCorreoElectronico">
									<label for="dni" class="col-form-label">Icono Texto Correo Electronico:</label>
									<select class="form-control fontawesomeSelect" id="slcCorreoElectronico" name="slcCorreoElectronico">
                                            <option value='fa-500px'>&#xf26e; fa-500px</option>
                                            <option value='fa-address-book'>&#xf2b9; fa-address-book</option>
                                            <option value='fa-address-book-o'>&#xf2ba; fa-address-book-o</option>
                                            <option value='fa-address-card'>&#xf2bb; fa-address-card</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                            <div class="mb-3">
                                    <input type="hidden" id="hdnNumeroCelular">
									<label for="dni" class="col-form-label">Icono Texto Numero Celular:</label>
									<select class="form-control fontawesomeSelect" id="slcNumeroCelular" name="slcNumeroCelular">
                                            <option value='fa-500px'>&#xf26e; fa-500px</option>
                                            <option value='fa-address-book'>&#xf2b9; fa-address-book</option>
                                            <option value='fa-address-book-o'>&#xf2ba; fa-address-book-o</option>
                                            <option value='fa-address-card'>&#xf2bb; fa-address-card</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                            <div class="mb-3">
                                    <input type="hidden" id="hdnNombrePersona">
									<label for="dni" class="col-form-label">Icono Texto Nombre Persona:</label>
									<select class="form-control fontawesomeSelect" id="slcNombrePersona" name="slcNombrePersona">
                                            <option value='fa-500px'>&#xf26e; fa-500px</option>
                                            <option value='fa-address-book'>&#xf2b9; fa-address-book</option>
                                            <option value='fa-address-book-o'>&#xf2ba; fa-address-book-o</option>
                                            <option value='fa-address-card'>&#xf2bb; fa-address-card</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                            <div class="mb-3">
                                    <input type="hidden" id="hdnAdicional">
									<label for="dni" class="col-form-label">Icono Texto Adicional:</label>
									<select class="form-control fontawesomeSelect" id="slcAdicional" name="slcAdicional">
                                            <option value='fa-500px'>&#xf26e; fa-500px</option>
                                            <option value='fa-address-book'>&#xf2b9; fa-address-book</option>
                                            <option value='fa-address-book-o'>&#xf2ba; fa-address-book-o</option>
                                            <option value='fa-address-card'>&#xf2bb; fa-address-card</option>
...
<script type="text/javascript">
    ...
    document.getElementById('btnModificarFormulario').addEventListener('click', (event) => {
        ...
        let slcDni = document.getElementById('slcDni');
        let slcCorreoElectronico = document.getElementById('slcCorreoElectronico');
        let slcNumeroCelular = document.getElementById('slcNumeroCelular');
        let slcNombrePersona = document.getElementById('slcNombrePersona');
        let slcAdicional = document.getElementById('slcAdicional');
        let hdnDni = document.getElementById('hdnDni');
        let hdnCorreoElectronico = document.getElementById('hdnCorreoElectronico');
        let hdnNumeroCelular = document.getElementById('hdnNumeroCelular');
        let hdnNombrePersona = document.getElementById('hdnNombrePersona');
        let hdnAdicional = document.getElementById('hdnAdicional');
                ...
                switch (data.ELEM_Tipo) {
                    ...
                    case 'T': 
                        if(data.ELEM_Id == 3) {
                            ...
                            hdnDni.value = data.ELEM_Icono;
                            slcDni.value = recuperarValorIcono(data.icono,tipoFormulario);
                        } else if (data.ELEM_Id == 4) {
                            txtCorreoElectronico.value = data.Valor;
                            hdnCorreoElectronico.value = data.ELEM_Icono;
                            slcCorreoElectronico.value = recuperarValorIcono(data.icono,tipoFormulario);
                        } else if (data.ELEM_Id == 5) {
                            txtNumeroCelular.value = data.Valor;
                            hdnNumeroCelular.value = data.ELEM_Icono;
                            slcNumeroCelular.value = recuperarValorIcono(data.icono,tipoFormulario);
                        } else if (data.ELEM_Id == 6) {
                            txtNombrePersona.value = data.Valor;
                            hdnNombrePersona.value = data.ELEM_Icono;
                            slcNombrePersona.value = recuperarValorIcono(data.icono,tipoFormulario);
                        } else if (data.ELEM_Id == 7) {
                            txtTextoAdicional.value = data.Valor;
                            hdnAdicional.value = data.ELEM_Icono;
                            slcAdicional.value = recuperarValorIcono(data.icono,tipoFormulario);
                        }
                    break;
                    case 'I': 
                        if(data.ELEM_Id == 2) {
    ...
    function recuperarValorIcono(arreglo, tipoFormulario) {
        if(tipoFormulario == 1)
        {
            return arreglo[1];
        }
    ...
    document.getElementById('guardarFormulario').addEventListener('click', (event) => {
        ...
        let formData = new FormData();
            ...
            formData.append('slcCorreoElectronico', slcCorreoElectronico.value);
            formData.append('slcNumeroCelular', slcNumeroCelular.value);
            formData.append('slcNombrePersona', slcNombrePersona.value);
            formData.append('slcAdicional', slcAdicional.value);
            formData.append('hdnDni', hdnDni.value);
            formData.append('hdnCorreoElectronico', hdnCorreoElectronico.value);
            formData.append('hdnNumeroCelular', hdnNumeroCelular.value);
            formData.append('hdnNombrePersona', hdnNombrePersona.value);
            formData.append('hdnAdicional', hdnAdicional.value);
